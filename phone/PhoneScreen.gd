...
const PHONE_ENTRY_LEFT = preload("res://phone/PhoneEntryLeft.tscn")
const PHONE_ENTRY_RIGHT = preload("res://phone/PhoneEntryRight.tscn")
const TIME_STAMP = preload("res://phone/TimeStamp.tscn")
